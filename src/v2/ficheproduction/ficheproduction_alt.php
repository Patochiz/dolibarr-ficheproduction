 ...
 *
 * Alternative version with direct CSS/JS inclusion
 * Use this if main version has issues with file inclusion
 */
...
// Standard header without CSS/JS parameters
llxHeader('', $langs->trans('ProductionSheet'), '', '');

// Include CSS directly
print '<link rel="stylesheet" type="text/css" href="'.dol_buildpath('/custom/ficheproduction/css/ficheproduction.css', 1).'">';
...
print '<script type="text/javascript" src="'.dol_buildpath('/custom/ficheproduction/js/ficheproduction.js', 1).'"></script>';
...
print '  } else {';
print '    console.error("ColisageManager not loaded - checking file path");';
print '    console.log("Expected JS file at: '.dol_buildpath('/custom/ficheproduction/js/ficheproduction.js', 1).'");';
print '  }';
print '});';
print '</script>';
